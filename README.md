...
- **`/data_projects`**: Professional data analysis projects, including KPI reporting, ETL pipelines, and business intelligence (Matplotlib/Pandas).
- **`/security`**: Scripts focused on cybersecurity concepts, including brute-force simulation and data encryption.
- **`/games`**: Logic-based interactive applications like "Rock Paper Scissors" and "Even or Odd".
- **`/fundamentals`**: Core Python syntax, loops, and algorithm challenges (FizzBuzz, counters, etc.).
